...
public static String  _aclock_click() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub Aclock_Click";
 //BA.debugLineNum = 233;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 234;BA.debugLine="ToastMessageShow( DateTime.Time(DateTime.Now), Fa";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("root not found..."),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 174;BA.debugLine="ToastMessageShow(\"running in background...\",True";
...
_setrandom_local();
 //BA.debugLineNum = 181;BA.debugLine="StartServiceAt(wautch_service,DateTime.Now, True)";
anywheresoftware.b4a.keywords.Common.StartServiceAt(processBA,(Object)(mostCurrent._wautch_service.getObject()),anywheresoftware.b4a.keywords.Common.DateTime.getNow(),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 183;BA.debugLine="StartServiceAt(Schedule,DateTime.Now + 1 * 1000,";
anywheresoftware.b4a.keywords.Common.StartServiceAt(processBA,(Object)(mostCurrent._vv1.getObject()),(long) (anywheresoftware.b4a.keywords.Common.DateTime.getNow()+1*1000),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 185;BA.debugLine="time_I = DateTime.Now";
_time_i = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 186;BA.debugLine="time_II = 0";
_time_ii = (long) (0);
 //BA.debugLineNum = 187;BA.debugLine="time_III = DateTime.Now";
_time_iii = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 188;BA.debugLine="time_IV = 0";
_time_iv = (long) (0);
...
_setrandom_local();
 //BA.debugLineNum = 209;BA.debugLine="ToastMessageShow( Rnd(1,64) , True )";
...
_setrandom_local();
 //BA.debugLineNum = 226;BA.debugLine="Label1.TextSize = 18 - random13";
mostCurrent._label1.setTextSize((float) (18-_v0()));
 //BA.debugLineNum = 227;BA.debugLine="SetRandom_Local";
_setrandom_local();
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 384;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 386;BA.debugLine="CheckBox1.Enabled = True";
mostCurrent._checkbox1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 387;BA.debugLine="CheckBox1.Visible = True";
mostCurrent._checkbox1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 389;BA.debugLine="CheckBox1.Checked = False";
mostCurrent._checkbox1.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 391;BA.debugLine="Aclock.Visible = True";
mostCurrent._v7.setVisible(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._button2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 394;BA.debugLine="Button1.Visible = False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 395;BA.debugLine="Button1.SendToBack";
mostCurrent._button1.SendToBack();
 //BA.debugLineNum = 396;BA.debugLine="CheckBox1.BringToFront";
mostCurrent._checkbox1.BringToFront();
 //BA.debugLineNum = 398;BA.debugLine="Activity.Title = \"waut.ch! running... ? for help,";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("waut.ch! running... ? for help, space to clear page"));
 //BA.debugLineNum = 399;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 401;BA.debugLine="End Sub";
return "";
}
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 240;BA.debugLine="Button2.Enabled = False";
mostCurrent._button2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 242;BA.debugLine="time_I = DateTime.Now";
_time_i = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 244;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 246;BA.debugLine="If ( time_I > ( time_II + 1500 ) ) Then";
if ((_time_i>(_time_ii+1500))) { 
 //BA.debugLineNum = 247;BA.debugLine="ToastMessageShow( \"utility for background calibr";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("utility for background calibration, curation and tuning of the device towards an intuitive interface. subsystems being battery, entropy, encryption, disk, cpu, memory, filesystem, ui, scheduler, and network, all safe and open source technology. presented in this gaming metric format with infinite feedback and an interestingly assymetric chance. click the number, find the difference!"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 248;BA.debugLine="time_II = DateTime.Now";
_time_ii = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 };
 //BA.debugLineNum = 251;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 253;BA.debugLine="Button2.Enabled = True";
...
public static String  _checkbox1_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 268;BA.debugLine="Sub CheckBox1_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 271;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 289;BA.debugLine="Activity.Title = \"waut.ch! running... ! to redraw";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("waut.ch! running... ! to redraw elements"));
 //BA.debugLineNum = 290;BA.debugLine="SetRandom_Local";
_setrandom_local();
...
boolean _dummy = false;
 //BA.debugLineNum = 257;BA.debugLine="Sub Label1_Click";
 //BA.debugLineNum = 258;BA.debugLine="Dim dummy As Boolean";
_dummy = false;
 //BA.debugLineNum = 259;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 260;BA.debugLine="ToastMessageShow( Rnd(1,64), True )";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (64))),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 261;BA.debugLine="SetRandom_Local";
_setrandom_local();
 //BA.debugLineNum = 262;BA.debugLine="End Sub";
return "";
}
public static String  _panel1_click() throws Exception{
 //BA.debugLineNum = 264;BA.debugLine="Sub Panel1_Click";
 //BA.debugLineNum = 265;BA.debugLine="SetRandom_Local";
_setrandom_local();
...
//C
this.state = 1;
 //BA.debugLineNum = 302;BA.debugLine="Dim random_long As Long";
_random_long = 0L;
 //BA.debugLineNum = 304;BA.debugLine="Dim i,j,k As Int";
_i = 0;
_j = 0;
_k = 0;
 //BA.debugLineNum = 308;BA.debugLine="If Aclock.Visible = False Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 310;BA.debugLine="time_IV = DateTime.Now";
parent._time_iv = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 318;BA.debugLine="If ( time_IV > ( time_III + 5000 ) ) Then";
if (true) break;

case 4:
//if
this.state = 7;
if ((parent._time_iv>(parent._time_iii+5000))) { 
this.state = 6;
}if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 319;BA.debugLine="ToastMessageShow( Rnd(1,64) , True )";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (64))),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 322;BA.debugLine="Activity.Finish";
parent.mostCurrent._activity.Finish();
 if (true) break;
;
 //BA.debugLineNum = 326;BA.debugLine="For j = 1 To 64";
...
//C
this.state = 10;
 //BA.debugLineNum = 328;BA.debugLine="For i = 1 To 64";
if (true) break;
...
//C
this.state = 13;
 //BA.debugLineNum = 329;BA.debugLine="random_long = Rnd(1,2+Abs(Action)+(Abs(X)*Abs(";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (2+anywheresoftware.b4a.keywords.Common.Abs(_action)+(anywheresoftware.b4a.keywords.Common.Abs(_x)*anywheresoftware.b4a.keywords.Common.Abs(_y)))));
 //BA.debugLineNum = 330;BA.debugLine="If(Rnd(1,64) > 30 ) Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 331;BA.debugLine="random_long = Rnd(1,1+Rnd(1,922337203685477))";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (1+anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (922337203685477L)))));
 //BA.debugLineNum = 332;BA.debugLine="random_long = Rnd(1+random12,9-random12)";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1+_vv2()),(int) (9-_vv2())));
 //BA.debugLineNum = 333;BA.debugLine="random_long = Rnd(1+random12,9-random12)";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1+_vv2()),(int) (9-_vv2())));
 //BA.debugLineNum = 334;BA.debugLine="random_long = random13";
...
if (true) break;
;
 //BA.debugLineNum = 338;BA.debugLine="For i = 1 To 64";
...
//C
this.state = 20;
 //BA.debugLineNum = 339;BA.debugLine="random_long = Rnd(1,2+Abs(Action)+(Abs(X)*Abs(";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (2+anywheresoftware.b4a.keywords.Common.Abs(_action)+(anywheresoftware.b4a.keywords.Common.Abs(_x)*anywheresoftware.b4a.keywords.Common.Abs(_y)))));
 //BA.debugLineNum = 340;BA.debugLine="If(Rnd(1,64) < 30 ) Then";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 341;BA.debugLine="random_long = Rnd(1,1+Rnd(1,922337203685477))";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (1+anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (922337203685477L)))));
 //BA.debugLineNum = 342;BA.debugLine="random_long = Rnd(1+random12,9-random12)";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1+_vv2()),(int) (9-_vv2())));
 //BA.debugLineNum = 343;BA.debugLine="random_long = Rnd(1+random12,9-random12)";
_random_long = (long) (anywheresoftware.b4a.keywords.Common.Rnd((int) (1+_vv2()),(int) (9-_vv2())));
 //BA.debugLineNum = 344;BA.debugLine="random_long = random13";
_random_long = (long) (_v0());
 if (true) break;
...
this.state = 40;
;
 //BA.debugLineNum = 350;BA.debugLine="Label1.TextSize = 18 - random13";
parent.mostCurrent._label1.setTextSize((float) (18-_v0()));
 //BA.debugLineNum = 351;BA.debugLine="S2";
_vv3();
 //BA.debugLineNum = 352;BA.debugLine="Sleep(30)";
...
this.state = 40;
;
 //BA.debugLineNum = 353;BA.debugLine="Label1.Text = Rnd(1,64)";
...
this.state = 26;
;
 //BA.debugLineNum = 357;BA.debugLine="k = 50";
_k = (int) (50);
 //BA.debugLineNum = 359;BA.debugLine="If Activity.Height > 1000 Then k = 85";
if (true) break;
...
this.state = 32;
;
 //BA.debugLineNum = 361;BA.debugLine="If Activity.Width > 1000 Then k = 85";
if (true) break;
...
this.state = 38;
;
 //BA.debugLineNum = 363;BA.debugLine="i = random13";
_i = _v0();
 //BA.debugLineNum = 364;BA.debugLine="j = random13";
_j = _v0();
 //BA.debugLineNum = 367;BA.debugLine="Label1.Top = Activity.Height / 2 + 3*k - (i+j)*k";
parent.mostCurrent._label1.setTop((int) (parent.mostCurrent._activity.getHeight()/(double)2+3*_k-(_i+_j)*_k));
 //BA.debugLineNum = 369;BA.debugLine="i = random13";
_i = _v0();
 //BA.debugLineNum = 370;BA.debugLine="j = random13";
_j = _v0();
 //BA.debugLineNum = 371;BA.debugLine="Label1.Left = Activity.Width / 2 + 3*k - (i+j)*k";
parent.mostCurrent._label1.setLeft((int) (parent.mostCurrent._activity.getWidth()/(double)2+3*_k-(_i+_j)*_k));
 //BA.debugLineNum = 373;BA.debugLine="Label1.TextSize = 22 - 2*random13";
parent.mostCurrent._label1.setTextSize((float) (22-2*_v0()));
 //BA.debugLineNum = 375;BA.debugLine="S2";
_vv3();
 //BA.debugLineNum = 376;BA.debugLine="Sleep(30)";
anywheresoftware.b4a.keywords.Common.Sleep(mostCurrent.activityBA,this,(int) (30));
this.state = 46;
return;
case 46:
...
this.state = 38;
;
 //BA.debugLineNum = 377;BA.debugLine="Label1.Text = Rnd(1,64)";
parent.mostCurrent._label1.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (64))));
 if (true) break;
...
//C
this.state = -1;
 //BA.debugLineNum = 297;BA.debugLine="Sleep(30)";
anywheresoftware.b4a.keywords.Common.Sleep(mostCurrent.activityBA,this,(int) (30));
this.state = 1;
return;
case 1:
...
public static String  _startservice_local() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub StartService_Local()";
