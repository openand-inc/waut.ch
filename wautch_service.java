...
_v5.execRootCmdSilent(anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin/busybox chmod -R 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin");
 //BA.debugLineNum = 76;BA.debugLine="rc.execRootCmdSilent(File.DirInternal & \"/bin/bu";
...
_v5.execRootCmdSilent(anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin/busybox chmod 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin/cb_networking.sh");
 //BA.debugLineNum = 85;BA.debugLine="rc.execRootCmdSilent( File.DirInternal & \"/bin/b";
...
_v5.execRootCmdSilent("/system/bin/toolbox chmod -R 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin");
 //BA.debugLineNum = 88;BA.debugLine="rc.execRootCmdSilent( \"/system/bin/toolbox chmod";
...
_v5.execRootCmdSilent("/system/bin/toybox chmod -R 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin");
 //BA.debugLineNum = 91;BA.debugLine="rc.execRootCmdSilent( \"/system/bin/toybox chmod";
_v5.execRootCmdSilent("/system/bin/toybox chmod 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin/busybox");
 //BA.debugLineNum = 93;BA.debugLine="rc.execRootCmdSilent( \"/system/bin/chmod -R 755";
_v5.execRootCmdSilent("/system/bin/chmod -R 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin");
 //BA.debugLineNum = 94;BA.debugLine="rc.execRootCmdSilent( \"/system/bin/chmod 755 \" &";
_v5.execRootCmdSilent("/system/bin/chmod 755 "+anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/bin/busybox");
 };
 //BA.debugLineNum = 104;BA.debugLine="Dim hour As Int";
_hour = 0;
 //BA.debugLineNum = 106;BA.debugLine="hour = DateTime.GetHour(DateTime.Now)";
_hour = anywheresoftware.b4a.keywords.Common.DateTime.GetHour(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 108;BA.debugLine="If hour = 3 Then";
if (_hour==3) { 
 //BA.debugLineNum = 109;BA.debugLine="If rc.haveRoot Then";
if (_v5.haveRoot()) { 
 //BA.debugLineNum = 113;BA.debugLine="rc.execRootCmdSilent( File.DirInternal & \"/bin/";
...
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub Service_Destroy";
...
int _hour = 0;
long _timeofday = 0L;
 //BA.debugLineNum = 120;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
 //BA.debugLineNum = 122;BA.debugLine="Dim hour As Int";
_hour = 0;
 //BA.debugLineNum = 123;BA.debugLine="Dim timeofday As Long";
_timeofday = 0L;
 //BA.debugLineNum = 125;BA.debugLine="hour = DateTime.GetHour(DateTime.Now)";
_hour = anywheresoftware.b4a.keywords.Common.DateTime.GetHour(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 127;BA.debugLine="timeofday = DateTime.Now + ( ( 27 - hour ) * 3600";
_timeofday = (long) (anywheresoftware.b4a.keywords.Common.DateTime.getNow()+((27-_hour)*3600000));
 //BA.debugLineNum = 129;BA.debugLine="StartServiceAt(\"\", timeofday , True)";
anywheresoftware.b4a.keywords.Common.StartServiceAt(processBA,(Object)(""),_timeofday,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 131;BA.debugLine="myStart";
_vv4();
 //BA.debugLineNum = 133;BA.debugLine="Service.StopAutomaticForeground 'Call this when t";
